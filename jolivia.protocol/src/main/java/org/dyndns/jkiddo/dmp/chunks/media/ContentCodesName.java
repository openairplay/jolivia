...
/**
 * The name of a ContentCode. It is needed to build a list of capabilities of the Server which is send to the client...
 * 
 * @author Roger Kapsi
 */
...
@DMAPAnnotation(type=DmapChunkDefinition.mcna)
