...
public interface AudioClock
{
	...
	/**
	 * Returns the earliest time in samples for which data is still accepted
	 * 
	...
	/**
	 * Returns the earliest time in frames for which data is still accepted
	 * 
	 * @return earliest playback time for new data
	 */
	 ...
	 * 
	 * @param frameTime
	 *            frame time to convert
	 * @return corresponding seconds time
	 */
	double convertFrameToSecondsTime(long frameTime);

	/**
	 * Adjusts the frame time so that the given frame time coindices with the given seconds time
	 * 
	 * @param frameTime
	 *            frame time corresponding to seconds time
	 * @param secondsTime
	 *            seconds time corresponding to frame time
	 */
