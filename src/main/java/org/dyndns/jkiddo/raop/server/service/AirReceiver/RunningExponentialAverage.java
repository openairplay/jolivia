...
public class RunningExponentialAverage
{
	 ...
	 *            the value to add
	 * @param weight
	 *            the value's weight between 0 and 1.
	 */
	...
	/**
	 * Return true until {@link #add(double, double)} has been called at least once for instances initialized without an initial value. Otherwise, always returns false.
	 */
