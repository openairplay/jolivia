...
/**
 * Described to format of a byte-based sample buffer (usually a {@link ByteBuffer}).
 * <p>
 * Used as a factory for {SampleIndexedAccessor} instances which provide access to the buffer's samples as float values indexed by their channel and sample index.
 */
public final class SampleByteBufferFormat
{
	...
	{
		this(SampleBufferLayout.Interleaved, audioFormat.isBigEndian() ? ByteOrder.BIG_ENDIAN : ByteOrder.LITTLE_ENDIAN, SampleByteFormat.fromAudioFormat(audioFormat));
	}
