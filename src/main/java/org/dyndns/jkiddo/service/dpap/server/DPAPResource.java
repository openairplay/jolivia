...
public class DPAPResource extends DMAPResource implements IImageLibrary
{
	...
	@Inject
	public DPAPResource(JmmDNS mDNS, Integer port, IItemManager itemManager) throws IOException
	{
	...
	protected ServiceInfo getServiceInfoToRegister()
	{
		...
		return ServiceInfo.create(DPAP_SERVICE_TYPE, itemManager.getLibraryName(), port, 0, 0, records);
	}
