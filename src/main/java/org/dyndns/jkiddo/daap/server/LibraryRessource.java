...
@Path("/")
public class LibraryRessource extends DMAPResource
{
	@Inject
	...
	static Logger logger = LoggerFactory.getLogger(LibraryRessource.class);

	@Inject
	public LibraryRessource(JmDNS mDNS, @Named(DAAP_PORT_NAME) Integer port, LibraryManager libraryManager) throws IOException
	{
		super(mDNS, port);
