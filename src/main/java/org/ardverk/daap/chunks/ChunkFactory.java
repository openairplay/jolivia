...
public final class ChunkFactory
{
	...
	public ChunkFactory()
	{
        ...
        map.put(new Integer(0x61766462), org.ardverk.daap.chunks.impl.ServerDatabases.class); //avdb
        map.put(new Integer(0x6D737276), org.ardverk.daap.chunks.impl.ServerInfoResponse.class); //msrv
        map.put(new Integer(0x6D757372), org.ardverk.daap.chunks.impl.ServerRevision.class); //musr
        map.put(new Integer(0x6D6C6964), org.ardverk.daap.chunks.impl.SessionId.class); //mlid
        map.put(new Integer(0x61655350), org.ardverk.daap.chunks.impl.SmartPlaylist.class); //aeSP
        map.put(new Integer(0x6173616C), org.ardverk.daap.chunks.impl.SongAlbum.class); //asal
        map.put(new Integer(0x61736172), org.ardverk.daap.chunks.impl.SongArtist.class); //asar
        map.put(new Integer(0x61736274), org.ardverk.daap.chunks.impl.SongBeatsPerMinute.class); //asbt
        map.put(new Integer(0x61736272), org.ardverk.daap.chunks.impl.SongBitrate.class); //asbr
        map.put(new Integer(0x61736374), org.ardverk.daap.chunks.impl.SongCategory.class); //asct
        map.put(new Integer(0x61736373), org.ardverk.daap.chunks.impl.SongCodecSubtype.class); //ascs
        map.put(new Integer(0x61736364), org.ardverk.daap.chunks.impl.SongCodecType.class); //ascd
        map.put(new Integer(0x6173636D), org.ardverk.daap.chunks.impl.SongComment.class); //ascm
        map.put(new Integer(0x6173636F), org.ardverk.daap.chunks.impl.SongCompilation.class); //asco
        map.put(new Integer(0x61736370), org.ardverk.daap.chunks.impl.SongComposer.class); //ascp
        map.put(new Integer(0x6173636E), org.ardverk.daap.chunks.impl.SongContentDescription.class); //ascn
        map.put(new Integer(0x61736372), org.ardverk.daap.chunks.impl.SongContentRating.class); //ascr
        map.put(new Integer(0x6173646B), org.ardverk.daap.chunks.impl.SongDataKind.class); //asdk
        map.put(new Integer(0x6173756C), org.ardverk.daap.chunks.impl.SongDataUrl.class); //asul
        map.put(new Integer(0x61736461), org.ardverk.daap.chunks.impl.SongDateAdded.class); //asda
        map.put(new Integer(0x6173646D), org.ardverk.daap.chunks.impl.SongDateModified.class); //asdm
        map.put(new Integer(0x61736474), org.ardverk.daap.chunks.impl.SongDescription.class); //asdt
        map.put(new Integer(0x61736462), org.ardverk.daap.chunks.impl.SongDisabled.class); //asdb
        map.put(new Integer(0x61736463), org.ardverk.daap.chunks.impl.SongDiscCount.class); //asdc
        map.put(new Integer(0x6173646E), org.ardverk.daap.chunks.impl.SongDiscNumber.class); //asdn
        map.put(new Integer(0x61736571), org.ardverk.daap.chunks.impl.SongEqPreset.class); //aseq
        map.put(new Integer(0x6173666D), org.ardverk.daap.chunks.impl.SongFormat.class); //asfm
        map.put(new Integer(0x6173676E), org.ardverk.daap.chunks.impl.SongGenre.class); //asgn
        map.put(new Integer(0x61677270), org.ardverk.daap.chunks.impl.SongGrouping.class); //agrp
        map.put(new Integer(0x61736B79), org.ardverk.daap.chunks.impl.SongKeywords.class); //asky
        map.put(new Integer(0x61736C63), org.ardverk.daap.chunks.impl.SongLongDescription.class); //aslc
        map.put(new Integer(0x61737276), org.ardverk.daap.chunks.impl.SongRelativeVolume.class); //asrv
        map.put(new Integer(0x61737372), org.ardverk.daap.chunks.impl.SongSampleRate.class); //assr
        map.put(new Integer(0x6173737A), org.ardverk.daap.chunks.impl.SongSize.class); //assz
        map.put(new Integer(0x61737374), org.ardverk.daap.chunks.impl.SongStartTime.class); //asst
        map.put(new Integer(0x61737370), org.ardverk.daap.chunks.impl.SongStopTime.class); //assp
        map.put(new Integer(0x6173746D), org.ardverk.daap.chunks.impl.SongTime.class); //astm
        map.put(new Integer(0x61737463), org.ardverk.daap.chunks.impl.SongTrackCount.class); //astc
        ...
        map.put(new Integer(0x6D73616C), org.ardverk.daap.chunks.impl.SupportsAutoLogout.class); //msal
        map.put(new Integer(0x6D736272), org.ardverk.daap.chunks.impl.SupportsBrowse.class); //msbr
        map.put(new Integer(0x6D736578), org.ardverk.daap.chunks.impl.SupportsExtensions.class); //msex
        map.put(new Integer(0x6D736978), org.ardverk.daap.chunks.impl.SupportsIndex.class); //msix
        map.put(new Integer(0x6D737069), org.ardverk.daap.chunks.impl.SupportsPersistentIds.class); //mspi
        map.put(new Integer(0x6D737179), org.ardverk.daap.chunks.impl.SupportsQuery.class); //msqy
        map.put(new Integer(0x6D737273), org.ardverk.daap.chunks.impl.SupportsResolve.class); //msrs
        map.put(new Integer(0x6D737570), org.ardverk.daap.chunks.impl.SupportsUpdate.class); //msup
        map.put(new Integer(0x6D73746D), org.ardverk.daap.chunks.impl.TimeoutInterval.class); //mstm
        map.put(new Integer(0x6165494D), org.ardverk.daap.chunks.impl.UnknownIM.class); //aeIM
        map.put(new Integer(0x6165524D), org.ardverk.daap.chunks.impl.UnknownRM.class); //aeRM
        map.put(new Integer(0x6D757064), org.ardverk.daap.chunks.impl.UpdateResponse.class); //mupd
        map.put(new Integer(0x6D757479), org.ardverk.daap.chunks.impl.UpdateType.class); //muty
	}
